...
-- Table `laravel`.`role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `laravel`.`role` (
...
CREATE TABLE IF NOT EXISTS `laravel`.`users` (
  ...
  CONSTRAINT `fk_users_role1`
    ...
    REFERENCES `laravel`.`role` (`id_role`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 2
...
-- -----------------------------------------------------
-- Table `laravel`.`polling`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `laravel`.`polling` (
...
-- -----------------------------------------------------
-- Table `laravel`.`kurikulum`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `laravel`.`kurikulum` (
...
-- -----------------------------------------------------
-- Table `laravel`.`mata_kuliah`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `laravel`.`mata_kuliah` (
  ...
  CONSTRAINT `fk_mata_kuliah_kurikulum1`
    ...
    REFERENCES `laravel`.`kurikulum` (`id_kurikulum`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `laravel`.`polling_detail`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `laravel`.`polling_detail` (
  ...
  CONSTRAINT `fk_polling_detail_polling1`
    ...
    REFERENCES `laravel`.`polling` (`id_polling`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_polling_detail_mata_kuliah1`
    FOREIGN KEY (`mata_kuliah_id_mk`)
    REFERENCES `laravel`.`mata_kuliah` (`id_mk`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
